...
public class StreamLessons {
	public static void demoA() {// empty
...
//	    System.out.println(intStream[0]);//Error
	...
	public static void demoH() {// generate//limit
		Stream<Integer> randomNumbers = Stream.generate(() -> (new Random()).nextInt(100));

		randomNumbers.limit(5).forEach(System.out::println);
	}

	public static void demoI() {// filter//map
	...
	public static void demoK() {// parallel steam
		List<Integer> list = new ArrayList<Integer>();
		for (int i = 1; i < 5; i++) {
			list.add(i);
		}
...
//         .filter(i -> i % 2 == 0)
	...
	public static void demoM3() { // distinct()
		List<Integer> list = Arrays.asList(2, 2, 4, 6, 8, 8, 10);
		List<Integer> l1 = list.stream().distinct().collect(Collectors.toList());
		System.out.println(l1);
	}

	public static void demoN() {// peek&map
...
>>>>>>> f0edc9dd9ec9cd8993d3ef7a221a3345b5ebbceb
